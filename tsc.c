...
*
* linux: gcc -Wall -O2 tcp_scan.c -o tcp_scan 
* osx: gcc -Wall -O2 tcp_scan.c -o tcp_scan
* win32: gcc -Wall -O2 tcp_scan.c -o tcp_scan -lwsock32
* solaris: gcc -Wall -O2 tcp_scan.c -o tcp_scan -lsocket -lnsl
*
*******************************/
